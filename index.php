    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="https://images.pexels.com/photos/29029291/pexels-photo-29029291/free-photo-of-colorful-assortment-of-decorative-pumpkins.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="img-fluid" width="300" />
          <div>
...
<!-- article end -->
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://images.pexels.com/photos/5624130/pexels-photo-5624130.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://images.pexels.com/photos/14505031/pexels-photo-14505031.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://images.pexels.com/photos/14505030/pexels-photo-14505030.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="https://images.pexels.com/photos/5624130/pexels-photo-5624130.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="d-block w-100" alt="..." />
            </div>
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://web.rupa.ai/wp-content/uploads/2023/06/GVS_A_positive_facial_expression_for_a_professional_profile_pic_e4c6acb9-1780-4deb-8def-ecb80f197f08.png"
              class="rounded-circle border shadow"
              width="300"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.15128</h3>
            <h1 class="fw-bold">Muhammad Kevin Kautsar</h1>
    ...
    <footer id="footer" class="text-center p-5">
      ...
      <div>Muhammad Kevin Kautsar &copy; 2023</div>
    </footer>
    <!-- footer end -->
